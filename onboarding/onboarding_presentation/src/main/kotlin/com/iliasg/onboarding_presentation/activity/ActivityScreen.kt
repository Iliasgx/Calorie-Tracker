package com.iliasg.onboarding_presentation.activity
...
import com.iliasg.core.utils.UiEvent
import com.iliasg.core_ui.LocalSpacing
import com.iliasg.onboarding_presentation.components.ActionButton
import com.iliasg.onboarding_presentation.components.SelectableButton
...
fun ActivityScreen(
    ...
    LaunchedEffect(key1 = true) {
        viewModel.uiEvent.collect { event ->
            // Only continue if the input was valid.
            if (event is UiEvent.Success) onNextClick()
        }
    }
